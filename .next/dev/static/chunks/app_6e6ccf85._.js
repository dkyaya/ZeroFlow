...
function LoginPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            const move = {
                "LoginPage.useEffect.move": (e)=>{
                    setPos({
                        x: e.clientX,
                        y: e.clientY
                    });
                }
            }["LoginPage.useEffect.move"];
            window.addEventListener("mousemove", move);
            return ({
                "LoginPage.useEffect": ()=>window.removeEventListener("mousemove", move)
            })["LoginPage.useEffect"];
        }
    }["LoginPage.useEffect"], []);
...
_s(LoginPage, "OE5+dhIxfNROED1vkecCFOI1DFM=", false, function() {
    return [
...
//# sourceMappingURL=app_6e6ccf85._.js.map