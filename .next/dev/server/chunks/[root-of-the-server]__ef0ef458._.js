...
async function POST(req) {
    try {
        ...
        const { firstName, lastName, preferredName, email, password, height, weight, age, sex, goal, activityLevel, unitSystem } = data;
        // Basic validation
        if (!firstName || !lastName || !email || !password || !height || !weight || !age || !sex || !goal || !activityLevel || !unitSystem) {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
                email
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ef0ef458._.js.map